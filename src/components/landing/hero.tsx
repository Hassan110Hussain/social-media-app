...
const Hero = () => {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-4 py-12 pt-24 text-slate-900 transition-colors dark:bg-black dark:text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-xl text-lg text-slate-600 dark:text-gray-300 lg:mx-0">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="space-y-1">
                <div className="bg-linear-to-r from-blue-500 to-cyan-500 bg-clip-text text-2xl font-bold text-transparent">10M+</div>
                <div className="text-sm text-slate-500 dark:text-gray-400">Active Users</div>
              </div>
              <div className="space-y-1">
                <div className="bg-linear-to-r from-purple-500 to-pink-500 bg-clip-text text-2xl font-bold text-transparent">50M+</div>
                <div className="text-sm text-slate-500 dark:text-gray-400">Posts Shared</div>
              </div>
              <div className="space-y-1">
                <div className="bg-linear-to-r from-green-500 to-emerald-500 bg-clip-text text-2xl font-bold text-transparent">150+</div>
                <div className="text-sm text-slate-500 dark:text-gray-400">Countries</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4 pt-12">
                <div className="translate-y-8 rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-lg shadow-blue-500/10 transition-all duration-300 hover:border-blue-500/50 hover:shadow-blue-500/30 dark:border-gray-800 dark:bg-gray-900/50 dark:shadow-blue-500/20">
                ...
                <div className="translate-y-8 rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-lg shadow-purple-500/10 transition-all duration-300 hover:border-purple-500/50 hover:shadow-purple-500/30 dark:border-gray-800 dark:bg-gray-900/50 dark:shadow-purple-500/20">
              ...
              <div className="space-y-4">
                <div className="translate-y-8 rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-lg shadow-pink-500/10 transition-all duration-300 hover:border-pink-500/50 hover:shadow-pink-500/30 dark:border-gray-800 dark:bg-gray-900/50 dark:shadow-pink-500/20">
                ...
                <div className="translate-y-8 rounded-3xl bg-linear-to-br from-blue-600 via-purple-600 to-pink-600 p-6 text-white shadow-lg transition-all duration-300 hover:shadow-purple-500/50">
